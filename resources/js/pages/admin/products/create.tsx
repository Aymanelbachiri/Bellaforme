        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold tracking-tight">Créer un produit</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {/* Brochure (available for both modes) */}
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid gap-2">
                                ...
                                {previews.brochure_file && (
                                    <p className="text-sm text-muted-foreground">Sélectionné : {previews.brochure_file}</p>
                                )}
                                        ...
                                        <div className="space-y-2">
                                            {data.gallery.map((item, index) => (
                                                <div key={index} className="flex items-center gap-2 rounded border p-2">
                                                    ...
                                                    <img src={isGalleryFile(item) ? URL.createObjectURL(item) : item.url} alt={`Gallery ${index + 1}`} className="h-12 w-16 rounded object-cover shrink-0" />

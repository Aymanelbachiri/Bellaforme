...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Create', href: '/admin/brands/create' },
];

export default function BrandsCreate({ divisions, nextOrder = 0 }: { divisions: Pick<Division, 'id' | 'name'>[]; nextOrder?: number }) {
    ...
    function handleSubmit(e: FormEvent) {
        e.preventDefault();
        post('/admin/brands', { forceFormData: true });
    }
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold tracking-tight">Create Brand</h1>
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-2">
                                <Label>Logo *</Label>
                                {previews.logo && (
                                    <img src={previews.logo} alt="Logo preview" className="h-16 w-28 rounded object-contain" />
                                )}
                                <Button type="button" variant="outline" className="w-fit gap-2" onClick={() => openImagePicker('logo', 'brands')}>
                                    <ImageIcon className="h-4 w-4" />
                                    {previews.logo ? 'Change Logo' : 'Select Logo'}
                                </Button>
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="flex items-center gap-2">
                                    ...
                                    <Label htmlFor="is_partner">Partner Brand</Label>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <Label htmlFor="is_reference">Reference Brand</Label>

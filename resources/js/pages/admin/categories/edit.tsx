...
export default function CategoriesEdit({ category, divisions }: { category: Category; divisions: Pick<Division, 'id' | 'name'>[] }) {
    ...
    const [previews, setPreviews] = useState<Record<string, string>>({
        ...
        hero_image: category.hero_image ? `/storage/${category.hero_image}` : '',
        video_cover: category.video_cover ? `/storage/${category.video_cover}` : '',
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4">
                <div className="flex items-center justify-between">
                    <h1 className="text-xl font-semibold tracking-tight">Modifier la catégorie</h1>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <div className="grid gap-2">
                                    ...
                                    {previews.hero_image && (
                                        <img src={previews.hero_image} alt={`${category.name} hero`} className="h-24 w-40 rounded object-cover" />
                                    )}
                    ...
                    <div className="flex justify-end">
                        <Button type="submit" disabled={processing}>{processing ? 'Enregistrement...' : 'Mettre à jour la catégorie'}</Button>
                    </div>
                </form>
            </div>

...
interface NosReferencesProps {
    divisions: DivisionWithBrands[];
    seo: SeoData;
}

export default function NosReferences({ divisions, seo }: NosReferencesProps) {
    return (
        <PublicLayout>
            <SeoHead {...seo} />
            <Head title="Nos Références" />
            ...
            >
                <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8" style={{ transform: 'scaleX(-1)' }}>
                    <h1
            ...
            <section className="bg-black py-16">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    {divisions.length === 0 ? (
                        <p className="text-center text-gray-400">Aucune référence pour le moment.</p>
                    ) : (
